...
def load_flights(airports):
    ...
    for line in content:
        ...
        departure_aiport_pointer = [airport for airport in airports if airport.code == flight_data[1]][0]
        ...
        flight = Flight(flight_data[0],                 #flight_number
                        departure_aiport_pointer,       #departure airport
...
def load_departures(flights, airplanes):
    ...
    for line in content:
        ...
        flight_rows_cols = [airplane.rows_cols for airplane in airplanes if airplane.code == flight_pointer.airplane_code][0]
...
def load_tickets(departures):
    ...
    for line in content:
        ...
        ticket = Ticket(ticket_data[0],            #ticket_id
                        departure_pointer.id,      #departure_id
